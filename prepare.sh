echo "127.0.0.1      capifcore" >> /etc/hosts

mkdir capif_onboarding
...
evolved5g register-and-onboard-to-capif --config_file_full_path="/app/capif_registration.json" --environment=$ENVIRONMENT &
